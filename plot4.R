...
par(mfrow=c(2,2))
plot(hd2$Full.Date, hd2$Global_active_power, type="l", ylab="Global Active Power", xlab="")
plot(hd2$Full.Date, hd2$Voltage, type="l", ylab="Voltage", xlab="datetime")

plot(hd2$Full.Date, hd2$Sub_metering_1, type="n", xlab="", ylab="Energy sub metering")
...
plot(hd2$Full.Date, hd2$Global_reactive_power, type="l", ylab="Global_reactive_power", xlab="datetime")
